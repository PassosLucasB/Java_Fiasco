package NivelIntermediario.Desafio5;
   /*
   *    Você vai criar um programa para gerenciar diferentes tipos de contas bancárias do Banco de Konoha.
   *    O objetivo é usar classes abstratas e interfaces para definir comportamentos comuns e
   * específicos para diferertes tipos de contas.
   ...
   *    6- Implemente o método depositar(double valor) para adicionar o valor ao saldo com
   * uma pequena taxa de depósito (por exemplo, deduzir 1% do valor depositado).
   *
   * */
public class Main {
}
